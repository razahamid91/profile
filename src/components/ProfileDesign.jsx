        ...
        <div>
            ...
            <div className="profile-description flex flex-col justify-start items-start md:justify-center md:items-center gap-5 sm:gap-8 md:gap-10 px-2 sm:px-4 md:px-14">
                ...
                <div className="photo-details flex flex-col gap-2 w-fit">
                    <h3 className="text-md md:text-lg">Aspiring Software Developer</h3>
                    <a href="https://www.instagram.com/hamid_nizam_/" className="text-blue-500 text-md md:text-lg" target="_blank" rel="noreferrer">https://www.instagram.com/hamid_nizam_/</a>
